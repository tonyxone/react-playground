...
class Action5 extends Component {
                    ...
                    <div className="container">
                        <div className="split split-one">
                            <div className="round round-one current">
                                ...
                                <ul className="matchup">
                                    <li className="team team-top"><span id='Duke' onClick={(e)=>this.teamClick(e)}>Duke</span></li>
                                    <li className="team team-bottom"><span id='Virginia' onClick={(e)=>this.teamClick(e)}>Virginia</span></li>
                                </ul>
                                <ul className="matchup">
                        ...
                        <div className="champion">
                            ...
                            <div className="final">
                                ...
                                <div className="round-details">championship <br/><span className="date">March 30 - Apr. 1</span>
                                </div>
                                <ul className="matchup championship">
                                    <li className="team team-top">&nbsp;<span className="vote-count">&nbsp;</span></li>
                                    <li className="team team-bottom">&nbsp;<span className="vote-count">&nbsp;</span>
